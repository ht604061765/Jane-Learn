    ...
    public static BigDecimal castBigDecimal(Object obj) {
        ...
        if (obj != null) {
            if (obj instanceof BigDecimal) {
                bigDecimalValue = (BigDecimal) obj;
            } else if (obj instanceof String) {
                bigDecimalValue = new BigDecimal((String) obj);
            } else if (obj instanceof BigInteger) {
                bigDecimalValue = new BigDecimal((BigInteger) obj);
            } else if (obj instanceof Number) {
                bigDecimalValue = new BigDecimal(((Number) obj).doubleValue());
            } else {
                throw new ClassCastException("将对象【" + obj + "】从【" + obj.getClass() + "】类型转化BigDecimal类型失败。");
            }
        }
